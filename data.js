// Elden Ring Nightreign — Static Game Data
// Sources: eldenringnightreign.wiki.fextralife.com, Bandai Namco
// Last updated: 2026-02-18
// This is the single source of truth for all game objects.
// app.js reads from this file only — do not put game data in app.js.
...
const CHARACTERS = {
  wylder: {
    id: 'wylder',
    name: 'Wylder',
    description: 'A balanced all-rounder, effective both in speed and attack power. Proficient with melee weapons, particularly greatswords. Suitable for newcomers.',
    image: null,
    scaling: { str: 'A', dex: 'B', int: 'C', fai: 'C', arc: 'C' },
    lvl1:  { hp: 240,  fp: 65,  stamina: 54,  vig: 8,  mnd: 4,  end: 3,  str: 5,  dex: 4,  int: 2,  fai: 2,  arc: 10 },
  ...
  guardian: {
    id: 'guardian',
    name: 'Guardian',
    description: 'A tank with heavy attacks and increased damage resistance. Excels at protecting allies and absorbing damage with a massive shield.',
    image: null,
    ...
    ultimate: { name: 'Wings of Salvation',desc: 'Leap up and dive back down to raise a protective area. Instantly resurrects nearby allies and grants damage immunity within the aura.' },
    startingEquipment: ["Guardian's Greatshield", "Guardian's Spear"],
  },
  ironeye: {
    id: 'ironeye',
    name: 'Ironeye',
    description: 'An archer with split-second judgement and pinpoint accuracy. Excels with bows and exploiting enemy weak points.',
    image: null,
    ...
    passive:  { name: 'Eagle Eye',   desc: 'A keenly observant eye discovers more items from foes. Bonus extends to all expedition members.' },
  ...
  duchess: {
    id: 'duchess',
    name: 'Duchess',
    description: 'A nimble fighter who specializes in stealth, exceptional dodge mechanics, and the ability to replay past attacks.',
    image: null,
  ...
  raider: {
    id: 'raider',
    name: 'Raider',
    description: 'A powerful sea-farer who favors enormous weapons. Unstoppable brawler with massive Strength scaling. Cannot be knocked down while using key abilities.',
    image: null,
  ...
  recluse: {
    id: 'recluse',
    name: 'Recluse',
    description: 'A witch of the deep forest who deftly wields ancient sorceries. A powerful dual-school spellcaster who collects elemental residues to fuel devastating magic cocktails.',
    image: null,
    ...
    passive:  { name: 'Elemental Defense',   desc: 'Discover affinity residues that can be collected to replenish FP.' },
    skill:    { name: 'Magic Cocktail',      desc: 'Collect affinity residues from targets to fire an affinity-exploiting magic cocktail with effects based on element combinations.', cooldown: null },
    ultimate: { name: 'Soulblood Song',      desc: 'Unleash forbidden blood chant to brand nearby foes with blood sigils. Marks enemies — striking them restores HP and FP for self and allies.' },
    startingEquipment: ["Recluse's Staff", "Recluse's Seal"],
  },
  executor: {
    id: 'executor',
    name: 'Executor',
    description: 'A katana-wielding, parry-focused fighter who excels in one-on-one combat with Sekiro-style deflection and status ailment recovery.',
    image: null,
    ...
    passive:  { name: 'Tenacity',                    desc: 'Receive boost after recovering from status ailments — provides attack power and stamina recovery for ~20 seconds.' },
    skill:    { name: 'Suncatcher',                  desc: 'Draw a cursed sword enabling deflection mechanics with a generous deflect window and negligible stamina consumption.', cooldown: null },
    ultimate: { name: 'Aspects of the Crucible: Beast', desc: 'Assume the form of the primordial beast granting access to unique attacks and crowd control options for ~15 seconds.' },
    startingEquipment: ["Executor's Katana", "Executor's Mask"],
  },
  revenant: {
    id: 'revenant',
    name: 'Revenant',
    description: 'A summoner who can conjure phantoms and coordinate attacks with them. Raises fallen enemies as allies and can make the entire party temporarily immortal.',
    image: null,
    ...
    passive:  { name: 'Necromancy',     desc: 'Raise enemy ghosts to fight as allies — reanimates defeated foes as temporary phantom allies lasting ~1 minute.' },
  ...
  scholar: {
    id: 'scholar',
    name: 'Scholar',
    description: '(DLC — Forsaken Hollows) A member of the School of Hierodas who contracted a disease causing abnormally rapid aging. Specializes in consumables, buffing allies, and debuffing enemies through advanced Bagcraft.',
    image: null,
    isDLC: true,
    scaling: { str: 'D', dex: 'C', int: 'C', fai: 'C', arc: 'S' },
    lvl1:  { hp: 220, fp: 65,  stamina: 54, vig: 7,  mnd: 4,  end: 3,  str: 1,  dex: 2,  int: 4,  fai: 2,  arc: 50 },
    lvl15: { hp: 900, fp: 145, stamina: 98, vig: 41, mnd: 20, end: 25, str: 14, dex: 18, int: 28, fai: 15, arc: 50 },
    passive:  { name: 'Bagcraft',   desc: 'Store additional resources. Level up the power or effect of items by using them. Consumables can be upgraded twice per expedition for enhanced effectiveness and secondary effects.' },
    skill:    { name: 'Analyze',    desc: 'Study your enemies. The longer you observe, the better your combat advantage — applying progressive debuffs to foes and buffs to allies.', cooldown: null },
    ultimate: { name: 'Communion',  desc: 'Taboo Knowledge: damage is shared by linked enemies and can heal threaded allies. Creates spectral connections distributing damage and healing.' },
    startingEquipment: ["Scholar's Thrusting Sword"],
  },
  undertaker: {
    id: 'undertaker',
    name: 'Undertaker',
    description: '(DLC — Forsaken Hollows) An abbess who moves with great agility, focused on dealing heavy damage with her hammer. Mandated to slay the Nightlord through powerful Strength and Faith weapon arts.',
    image: null,
    isDLC: true,
    scaling: { str: 'A', dex: 'D', int: 'D', fai: 'A', arc: 'C' },
    lvl1:  { hp: 220,  fp: 65,  stamina: 54, vig: 7,  mnd: 4,  end: 3,  str: 5,  dex: 2,  int: 2,  fai: 5,  arc: 10 },
    lvl15: { hp: 1040, fp: 115, stamina: 92, vig: 48, mnd: 14, end: 22, str: 50, dex: 13, int: 5,  fai: 41, arc: 10 },
    passive:  { name: 'Confluence',    desc: "Ally's execution of art enables additional art activation regardless of gauge, allowing free Ultimate Art use when teammates activate theirs." },
    skill:    { name: 'Trance',        desc: 'Bloodletting triggers temporary buffs to speed, poise, and dodge. With a full Art gauge, grants significant attack power and automatic dodge protection.', cooldown: null },
    ultimate: { name: 'Loathsome Hex', desc: 'Pull out uncanny bone from body, speed toward target, and strike with substantial damage. Can be used mid-air to close distance on any foe.' },
    startingEquipment: ["Undertaker's Hammer"],
  },
};

// ============================================================
// TALISMANS  (up to 2 equipped per expedition)
// ============================================================

const TALISMANS = [
  { id: 'ancestral_horn',    name: "Ancestral Spirit's Horn",      effects: [{ stat: 'fpRegen',       type: 'percent',   value: 5,    label: 'FP on kill +5%' }] },
  ...
  { id: 'assassins_cerulean',name: "Assassin's Cerulean Dagger",   effects: [{ stat: 'fpRegen',       type: 'onCritical',value: 10,   label: 'Critical hit FP restore +10%' }] },
  { id: 'assassins_crimson', name: "Assassin's Crimson Dagger",    effects: [{ stat: 'hpRegen',       type: 'onCritical',value: 18,   label: 'Critical hit HP restore +18%' }] },
  ...
  { id: 'clarifying_horn',   name: 'Clarifying Horn Charm',        effects: [{ stat: 'sleepRes',      type: 'flat',      value: 75,   label: 'Sleep resistance +75' }, { stat: 'madnessRes', type: 'flat', value: 75, label: 'Madness resistance +75' }] },
  ...
  { id: 'faithful_canvas',   name: "Faithful's Canvas Talisman",   effects: [{ stat: 'holyAtk',       type: 'percent',   value: 11,   label: 'Incantation power +11%' }] },
  ...
  { id: 'godskin_cloth',     name: 'Godskin Swaddling Cloth',      effects: [{ stat: 'hpRegen',       type: 'onSuccessive',value: 6,  label: 'HP restore on successive attacks +6%' }] },
  { id: 'gold_scarab',       name: 'Gold Scarab',                  effects: [{ stat: 'runes',         type: 'percent',   value: 15,   label: 'Rune gain +15%' }] },
  { id: 'graven_school',     name: 'Graven-School Talisman',       effects: [{ stat: 'magicAtk',      type: 'percent',   value: 11,   label: 'Sorcery power +11%' }] },
  ...
  { id: 'immunizing_horn',   name: 'Immunizing Horn Charm',        effects: [{ stat: 'poisonRes',     type: 'flat',      value: 75,   label: 'Poison resistance +75' }, { stat: 'rotRes', type: 'flat', value: 75, label: 'Rot resistance +75' }] },
  { id: 'kindred_rot',       name: "Kindred of Rot's Exultation",  effects: [{ stat: 'physAtk',       type: 'onStatusNearby',value: 20,label: 'Attack power +20% on poison/rot nearby' }] },
  ...
  { id: 'lord_of_blood',     name: "Lord of Blood's Exultation",   effects: [{ stat: 'physAtk',       type: 'onBloodloss',value: 20,  label: 'Attack power +20% on bloodloss' }] },
  ...
  { id: 'millicent',         name: "Millicent's Prosthesis",       effects: [{ stat: 'dex',           type: 'percent',   value: 5,    label: 'Dex +5%' }, { stat: 'physAtk', type: 'successive', value: 1, label: 'Successive attacks boost attack power' }] },
  ...
  { id: 'perfumers',         name: "Perfumer's Talisman",          effects: [{ stat: 'perfumeAtk',    type: 'percent',   value: 20,   label: 'Perfuming arts +20%' }] },
  { id: 'prince_of_death',   name: "Prince of Death's Pustule",    effects: [{ stat: 'deathblightRes',type: 'flat',      value: 75,   label: 'Death Blight resistance +75' }] },
  ...
  { id: 'red_feather',       name: 'Red-Feathered Branchsword',    effects: [{ stat: 'physAtk',       type: 'lowHp',     value: 20,   label: 'Attack power at low HP +20%' }] },
  ...
  { id: 'ritual_sword',      name: 'Ritual Sword Talisman',        effects: [{ stat: 'physAtk',       type: 'fullHp',    value: 10,   label: 'Attack power at full HP +10%' }] },
  ...
  { id: 'stalwart_horn',     name: 'Stalwart Horn Charm',          effects: [{ stat: 'bleedRes',      type: 'flat',      value: 75,   label: 'Blood Loss resistance +75' }, { stat: 'frostRes', type: 'flat', value: 75, label: 'Frost resistance +75' }] },
  { id: 'symbol_of_avarice', name: 'Symbol of Avarice',            effects: [{ stat: 'itemDiscovery', type: 'special',   value: 1,    label: 'Item discovery greatly boosted' }, { stat: 'hpRegen', type: 'special', value: -1, label: 'Continuous HP loss' }] },
  { id: 'takers_cameo',      name: "Taker's Cameo",                effects: [{ stat: 'hpRegen',       type: 'onKill',    value: 6,    label: 'HP restore on kill +6%' }] },
  ...
  { id: 'winged_sword',      name: 'Winged Sword Insignia',        effects: [{ stat: 'physAtk',       type: 'successive',value: 1,    label: 'Attack power stacks on successive hits' }] },
];
...
// Standard effects — available in all runs
...
// Deep of Night exclusive effects
...
// Returns available relic effects based on Deep of Night toggle
function getRelicEffects(deepOfNight) {
  return deepOfNight ? [...RELIC_EFFECTS_STANDARD, ...RELIC_EFFECTS_DEEP] : RELIC_EFFECTS_STANDARD;
}
...
// ============================================================
// VESSELS  (per character; each has 3 relic slots)
//
// Vessel types:
//   Core (base game): Urn, Goblet, Chalice, Soot-Covered Urn, Sealed Urn
//   Universal Grails: Giant's Cradle, Sacred Erdtree, Spirit Shelter (all characters)
//   DLC (Forsaken Hollows): Decrepit Goblet, Forgotten Goblet, Scadutree Grail
// ============================================================

const VESSELS = {
  wylder: [
    { id: 'wylder_urn',         name: "Wylder's Urn",                   slots: ['red',    'red',    'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'wylder_goblet',      name: "Wylder's Goblet",                slots: ['yellow', 'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'wylder_chalice',     name: "Wylder's Chalice",               slots: ['red',    'yellow', 'white'], deepSlots: ['white', 'white', 'white']  },
    { id: 'wylder_soot',        name: "Soot-Covered Wylder's Urn",      slots: ['blue',   'blue',   'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'wylder_sealed',      name: "Sealed Wylder's Urn",            slots: ['blue',   'red',    'red'], deepSlots: ['white', 'white', 'white']    },
    { id: 'wylder_cradle',      name: "Giant's Cradle Grail",           slots: ['blue',   'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'wylder_erdtree',     name: "Sacred Erdtree Grail",           slots: ['yellow', 'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'wylder_shelter',     name: "Spirit Shelter Grail",           slots: ['green',  'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'wylder_decrepit',    name: "Decrepit Wylder's Goblet",       slots: ['blue',   'green',  'yellow'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'wylder_forgotten',   name: "Forgotten Wylder's Goblet",      slots: ['green',  'green',  'yellow'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'wylder_scadutree',   name: "Scadutree Grail",                slots: ['red',    'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
  ],
  guardian: [
    { id: 'guardian_urn',       name: "Guardian's Urn",                 slots: ['red',    'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'guardian_goblet',    name: "Guardian's Goblet",              slots: ['blue',   'blue',   'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'guardian_chalice',   name: "Guardian's Chalice",             slots: ['blue',   'yellow', 'white'], deepSlots: ['white', 'white', 'white']  },
    { id: 'guardian_soot',      name: "Soot-Covered Guardian's Urn",    slots: ['red',    'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'guardian_sealed',    name: "Sealed Guardian's Urn",          slots: ['yellow', 'yellow', 'red'], deepSlots: ['white', 'white', 'white']    },
    { id: 'guardian_cradle',    name: "Giant's Cradle Grail",           slots: ['blue',   'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'guardian_erdtree',   name: "Sacred Erdtree Grail",           slots: ['yellow', 'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'guardian_shelter',   name: "Spirit Shelter Grail",           slots: ['green',  'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'guardian_decrepit',  name: "Decrepit Guardian's Goblet",     slots: ['yellow', 'green',  'green'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'guardian_forgotten', name: "Forgotten Guardian's Goblet",    slots: ['green',  'blue',   'blue'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'guardian_scadutree', name: "Scadutree Grail",                slots: ['red',    'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
  ],
  ironeye: [
    { id: 'ironeye_urn',        name: "Ironeye's Urn",                  slots: ['yellow', 'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'ironeye_goblet',     name: "Ironeye's Goblet",               slots: ['red',    'blue',   'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'ironeye_chalice',    name: "Ironeye's Chalice",              slots: ['red',    'green',  'white'], deepSlots: ['white', 'white', 'white']  },
    { id: 'ironeye_soot',       name: "Soot-Covered Ironeye's Urn",     slots: ['blue',   'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'ironeye_sealed',     name: "Sealed Ironeye's Urn",           slots: ['green',  'green',  'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'ironeye_cradle',     name: "Giant's Cradle Grail",           slots: ['blue',   'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'ironeye_erdtree',    name: "Sacred Erdtree Grail",           slots: ['yellow', 'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'ironeye_shelter',    name: "Spirit Shelter Grail",           slots: ['green',  'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'ironeye_decrepit',   name: "Decrepit Ironeye's Goblet",      slots: ['blue',   'blue',   'green'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'ironeye_forgotten',  name: "Forgotten Ironeye's Goblet",     slots: ['yellow', 'blue',   'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'ironeye_scadutree',  name: "Scadutree Grail",                slots: ['red',    'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
  ],
  duchess: [
    { id: 'duchess_urn',        name: "Duchess' Urn",                   slots: ['red',    'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'duchess_goblet',     name: "Duchess' Goblet",                slots: ['yellow', 'yellow', 'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'duchess_chalice',    name: "Duchess' Chalice",               slots: ['blue',   'yellow', 'white'], deepSlots: ['white', 'white', 'white']  },
    { id: 'duchess_soot',       name: "Soot-Covered Duchess' Urn",      slots: ['red',    'red',    'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'duchess_sealed',     name: "Sealed Duchess' Urn",            slots: ['blue',   'blue',   'red'], deepSlots: ['white', 'white', 'white']    },
    { id: 'duchess_cradle',     name: "Giant's Cradle Grail",           slots: ['blue',   'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'duchess_erdtree',    name: "Sacred Erdtree Grail",           slots: ['yellow', 'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'duchess_shelter',    name: "Spirit Shelter Grail",           slots: ['green',  'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'duchess_decrepit',   name: "Decrepit Duchess' Goblet",       slots: ['blue',   'green',  'green'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'duchess_forgotten',  name: "Forgotten Duchess' Goblet",      slots: ['green',  'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'duchess_scadutree',  name: "Scadutree Grail",                slots: ['red',    'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
  ],
  raider: [
    { id: 'raider_urn',         name: "Raider's Urn",                   slots: ['red',    'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'raider_goblet',      name: "Raider's Goblet",                slots: ['red',    'blue',   'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'raider_chalice',     name: "Raider's Chalice",               slots: ['red',    'red',    'white'], deepSlots: ['white', 'white', 'white']  },
    { id: 'raider_soot',        name: "Soot-Covered Raider's Urn",      slots: ['blue',   'blue',   'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'raider_sealed',      name: "Sealed Raider's Urn",            slots: ['green',  'green',  'red'], deepSlots: ['white', 'white', 'white']    },
    { id: 'raider_cradle',      name: "Giant's Cradle Grail",           slots: ['blue',   'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'raider_erdtree',     name: "Sacred Erdtree Grail",           slots: ['yellow', 'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'raider_shelter',     name: "Spirit Shelter Grail",           slots: ['green',  'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'raider_decrepit',    name: "Decrepit Raider's Goblet",       slots: ['yellow', 'yellow', 'green'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'raider_forgotten',   name: "Forgotten Raider's Goblet",      slots: ['yellow', 'blue',   'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'raider_scadutree',   name: "Scadutree Grail",                slots: ['red',    'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
  ],
  recluse: [
    { id: 'recluse_urn',        name: "Recluse's Urn",                  slots: ['blue',   'blue',   'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'recluse_goblet',     name: "Recluse's Goblet",               slots: ['red',    'blue',   'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'recluse_chalice',    name: "Recluse's Chalice",              slots: ['yellow', 'green',  'white'], deepSlots: ['white', 'white', 'white']  },
    { id: 'recluse_soot',       name: "Soot-Covered Recluse's Urn",     slots: ['red',    'red',    'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'recluse_sealed',     name: "Sealed Recluse's Urn",           slots: ['green',  'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'recluse_cradle',     name: "Giant's Cradle Grail",           slots: ['blue',   'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'recluse_erdtree',    name: "Sacred Erdtree Grail",           slots: ['yellow', 'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'recluse_shelter',    name: "Spirit Shelter Grail",           slots: ['green',  'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'recluse_decrepit',   name: "Decrepit Recluse's Goblet",      slots: ['yellow', 'yellow', 'blue'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'recluse_forgotten',  name: "Forgotten Recluse's Goblet",     slots: ['yellow', 'blue',   'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'recluse_scadutree',  name: "Scadutree Grail",                slots: ['red',    'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
  ],
  executor: [
    { id: 'executor_urn',       name: "Executor's Urn",                 slots: ['red',    'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'executor_goblet',    name: "Executor's Goblet",              slots: ['red',    'blue',   'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'executor_chalice',   name: "Executor's Chalice",             slots: ['blue',   'yellow', 'white'], deepSlots: ['white', 'white', 'white']  },
    { id: 'executor_soot',      name: "Soot-Covered Executor's Urn",    slots: ['red',    'red',    'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'executor_sealed',    name: "Sealed Executor's Urn",          slots: ['yellow', 'yellow', 'red'], deepSlots: ['white', 'white', 'white']    },
    { id: 'executor_cradle',    name: "Giant's Cradle Grail",           slots: ['blue',   'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'executor_erdtree',   name: "Sacred Erdtree Grail",           slots: ['yellow', 'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'executor_shelter',   name: "Spirit Shelter Grail",           slots: ['green',  'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'executor_decrepit',  name: "Decrepit Executor's Goblet",     slots: ['red',    'red',    'yellow'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'executor_forgotten', name: "Forgotten Executor's Goblet",    slots: ['green',  'blue',   'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'executor_scadutree', name: "Scadutree Grail",                slots: ['red',    'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
  ],
  revenant: [
    { id: 'revenant_urn',       name: "Revenant's Urn",                 slots: ['blue',   'blue',   'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'revenant_goblet',    name: "Revenant's Goblet",              slots: ['red',    'red',    'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'revenant_chalice',   name: "Revenant's Chalice",             slots: ['blue',   'green',  'white'], deepSlots: ['white', 'white', 'white']  },
    { id: 'revenant_soot',      name: "Soot-Covered Revenant's Urn",    slots: ['red',    'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'revenant_sealed',    name: "Sealed Revenant's Urn",          slots: ['yellow', 'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'revenant_cradle',    name: "Giant's Cradle Grail",           slots: ['blue',   'blue',   'blue'], deepSlots: ['white', 'white', 'white']   },
    { id: 'revenant_erdtree',   name: "Sacred Erdtree Grail",           slots: ['yellow', 'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'] },
    { id: 'revenant_shelter',   name: "Spirit Shelter Grail",           slots: ['green',  'green',  'green'], deepSlots: ['white', 'white', 'white']  },
    { id: 'revenant_decrepit',  name: "Decrepit Revenant's Goblet",     slots: ['red',    'red',    'yellow'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'revenant_forgotten', name: "Forgotten Revenant's Goblet",    slots: ['green',  'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'revenant_scadutree', name: "Scadutree Grail",                slots: ['red',    'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
  ],
  scholar: [
    { id: 'scholar_urn',        name: "Scholar's Urn",                  slots: ['red',    'red',    'yellow'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'scholar_goblet',     name: "Scholar's Goblet",               slots: ['blue',   'green',  'yellow'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'scholar_chalice',    name: "Scholar's Chalice",              slots: ['red',    'blue',   'white'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'scholar_soot',       name: "Soot-Covered Scholar's Urn",     slots: ['blue',   'green',  'green'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'scholar_sealed',     name: "Sealed Scholar's Urn",           slots: ['yellow', 'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'scholar_cradle',     name: "Giant's Cradle Grail",           slots: ['blue',   'blue',   'blue'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'scholar_erdtree',    name: "Sacred Erdtree Grail",           slots: ['yellow', 'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'scholar_shelter',    name: "Spirit Shelter Grail",           slots: ['green',  'green',  'green'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'scholar_decrepit',   name: "Decrepit Scholar's Goblet",      slots: ['blue',   'blue',   'green'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'scholar_forgotten',  name: "Forgotten Scholar's Goblet",     slots: ['yellow', 'green',  'blue'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'scholar_scadutree',  name: "Scadutree Grail",                slots: ['red',    'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
  ],
  undertaker: [
    { id: 'undertaker_urn',        name: "Undertaker's Urn",                slots: ['blue',   'green',  'green'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'undertaker_goblet',     name: "Undertaker's Goblet",             slots: ['red',    'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'undertaker_chalice',    name: "Undertaker's Chalice",            slots: ['green',  'yellow', 'white'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'undertaker_soot',       name: "Soot-Covered Undertaker's Urn",   slots: ['red',    'red',    'blue'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'undertaker_sealed',     name: "Sealed Undertaker's Urn",         slots: ['green',  'green',  'blue'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'undertaker_cradle',     name: "Giant's Cradle Grail",            slots: ['blue',   'blue',   'blue'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'undertaker_erdtree',    name: "Sacred Erdtree Grail",            slots: ['yellow', 'yellow', 'yellow'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'undertaker_shelter',    name: "Spirit Shelter Grail",            slots: ['green',  'green',  'green'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'undertaker_decrepit',   name: "Decrepit Undertaker's Goblet",    slots: ['red',    'blue',   'blue'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'undertaker_forgotten',  name: "Forgotten Undertaker's Goblet",   slots: ['yellow', 'yellow', 'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
    { id: 'undertaker_scadutree',  name: "Scadutree Grail",                 slots: ['red',    'red',    'red'], deepSlots: ['white', 'white', 'white'], isDLC: true },
  ],
};
